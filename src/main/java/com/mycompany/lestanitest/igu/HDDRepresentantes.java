    ...
    private void generarPDF() {
        ...
        try {
            ...
            if (userSelection == JFileChooser.APPROVE_OPTION) {
                ...
                PdfPTable table = new PdfPTable(tablaMovimientos.getColumnCount() - 4); // Excluir columnas MOVIMIENTO,FECHA,REPRESENTANTE,Y OBS
                table.setSpacingBefore(10f); // Espacio antes de la tabla (en puntos)
                table.setSpacingAfter(10f);

                // Ajustar espacio horizontal
                float[] columnWidths = {0.9f, 1f, 0.7f, 0.7f, 1f, 0.6f, 1f, 0.6f, 0.8f, 0.5f}; // Anchos de las columnas (proporciones)
